...
extension CalendarEventQueryWhereSort
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhere> anyStartTime() {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQuerySortBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByIsAllDay() {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQuerySortThenBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByIsAllDay() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAllDay', Sort.asc);
    });
  }
...
extension CalendarEventQueryWhereDistinct
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByIsAllDay() {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQueryProperty
  ...
  QueryBuilder<CalendarEvent, bool, QQueryOperations> isAllDayProperty() {
    return QueryBuilder.apply(this, (query) {
